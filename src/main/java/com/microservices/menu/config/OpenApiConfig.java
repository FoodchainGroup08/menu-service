...
public class OpenApiConfig {
    ...
    public OpenAPI menuServiceOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("FoodChain — Menu Service API")
                        .description("Global product catalog — manage menu items and categories shared across all branches.")
                        .version("v1.0.0")
                        .contact(new Contact()
                ...
                .servers(List.of(
                        ...
                        new Server()
                                ...
                                .description("Menu Service direct (local dev)")))
